...
class WeatherServiceDarkskyTests: XCTestCase {
    ...
    func testEvaluateCondition(){
        ...
        let r = service.evaluateCondition(probability: prob, temp: Double(temp), intensity: inten, accumulation: accum, cover: cover, apiIcon: icon)
        print("test: r= \(r)")
